...
> Projeto desenvolvido na trilha de React.js do ignite onde foi criado do zero uma aplicação de autenticação de usuário com criação de token, refreshToken e controle de permissões do usuário
...
```bash
$ git clone https://github.com/alextfonseca/nextAuth.git
$ cd nextAuth
$ yarn / npm i
